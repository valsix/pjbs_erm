   ...
   Plugin.prototype =
           {
              ...
              constructHTMLCalendar: function (date, calendar)
              {
                 ...
                 for (var i = 0; i < calendar.days.length; i++)
                 {
                    ...
                    if ((i+1) % 7 == 0)
                      _template += '<td class="dtp-week-end" data-date="' + moment(calendar.days[i]).locale(this.params.lang).format("D") + '">';
                    else if((i+3) % 7 == 0)
                        _template += '<td class="dtp-week-jumat" data-date="' + moment(calendar.days[i]).locale(this.params.lang).format("D") + '">';
                    else
