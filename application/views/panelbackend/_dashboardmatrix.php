<div style="width:100%; padding:7px 10px;" class="dark-tooltip info-box-flat-active <?php echo "box-id-".$id_class; ?>" rel="tooltip" title="<?=$rk['nama']?>">
  <div style="width: 50%;height: 25px;float:left;padding-top: 3px; font-size:16px; overflow: hidden;text-overflow: unset;">
    <?=trim(str_replace(array("KAJIAN","RISIKO"), "", strtoupper($rk['nama'])))?>
    <div style="display: inline-block;">
                    <span class="label-total label label-info" style="display: block;top: 5.5px; padding: .5em; font-size: 90%;">
            <?=str_pad($total['total_risiko'],2,'0',STR_PAD_LEFT)?>          </span>
                  </div>
...
<div class="row clearfix">
    <div class="col-xs-12 col-sm-12">
        <div class="card" style="margin-bottom: 0px;">
                  ...
                  <div class="row" style="padding: 10px 20px; min-height: 204px">
                    <!-- <div class="col-sm-4">
                    <div  style="padding-top: 45px;text-align: center;">
                      <div style="padding-bottom:5px; width: 100px; font-weight: bold; margin: auto;">TOTAL</div>

                      <div style="font-size: 55px; padding: 0px;  margin-top: -15px; color: #025f9e;">
                        <?=$total['total_risiko']?>
                      </div>
                    ...
                    <div  style="padding-top: 15px; text-align: center;">
                      ...
                      <input type="text" class="knob" value="<?=$total['progress_mitigasi']?>" data-width="125" data-height="125" data-thickness="0.25" data-fgColor="rgb(1, 139, 156)" readonly>
                    </div>
                    </div>
                    <?php } ?>
                    ...
                    <div class="col-sm-6">
                      <div  style="padding-top: 15px; text-align: center;">
                        ...
                        <input type="text" class="knob" value="<?=$total['control_efektif']?>" data-width="125" data-height="125" data-thickness="0.25" data-fgColor="#E91E63" readonly>
                      </div>
                      </div>
                    <?php } ?>
                  </div>
                  ...
                  <div class="row" style="padding: 10px 20px">
                    <div class="col-xs-6">
                        <a href="#" style="text-decoration: none;" data-toggle="modal" data-target="#tablematrix<?=$id_class?>" onclick="reqtb(<?=$id_class?>, <?=$id_kajian_risiko?>)"><span class="glyphicon glyphicon-th-list"></span> TOP <?=$top?> RISIKO</a>
                    </div>
                    <div class="col-xs-6">
                        <a href="#" style="text-decoration: none;" data-toggle="modal" data-target="#grafikmatrix<?=$id_class?>"><span class="glyphicon glyphicon-th"></span> MATRIKS RISIKO</a>
                    </div>
                  </div>



<div class="modal fade" id="grafikmatrix<?=$id_class?>">
  <div class="modal-dialog" role="document">
      <div class="modal-content">
          <div class="modal-header">
                <center>
                  <h4 class="modal-title">TOP <input type="text" style="border: 0px;width: 25px;" onchange="req(<?=$id_class?>,<?=$id_kajian_risiko?>)" name="top" id="top<?=$id_class?>" value="<?=$top?>"/> MATRIKS<br/><?=strtoupper($rk['nama'])?> <?php if($scorecard_name) { ?> <br/><small><?=trim(implode(" / ",$scorecard_name)," / ")?></small><?php } ?> </h4>
                </center>
          </div>
