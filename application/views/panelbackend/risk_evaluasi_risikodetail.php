                                ...
                                <?php
                                    ...
                                    if($is_close){
                                        ...
                                        if($this->post['status_risiko']==='0'){
                                            echo "<div class='close".$r['id_risiko']."' style=''><b style='display:inline'>Tgl. Close </b>".UI::createTextBox('tgl_close_'.$r['id_risiko'],date('d-m-Y'),'','',true,'form-control datepickerstart', "style='width:100px; display:inline'")."</div>";
                                        }
                                    }
