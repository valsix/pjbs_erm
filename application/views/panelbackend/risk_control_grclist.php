...
<?php if(!$editedheader1 && $this->access_role['edit']  && (!$rowheader1['is_lock'] or $this->access_role_custom['panelbackend/risk_risiko_grc']['view_all_direktorat'])){ 
    ?>
    <a href="<?=site_url("panelbackend/risk_control_grc/index/$rowheader1[id_risiko]/0/1")?>" class="btn btn-xs btn-default fright"><span class="glyphicon glyphicon-edit"></span> Edit</a>
    <?php } ?>
</div>
