...
<div class="body table-responsive" style="padding:0px">
  <table class="table table-bordered table-hover dataTable">
    ...
    <tbody>
    <?php
$editedheader1 = ($editedheader1 && (!$rowheader1['is_lock'] or $this->access_role_custom['panelbackend/risk_risiko_grc']['view_all_direktorat']));
    $i = $page;
    $unlock = 0;
    foreach($list['rows'] as $rows){
        ...
        }elseif((accessbystatus($rowheader1['id_status_pengajuan']) && $rows['is_lock']!='1') or $this->access_role_custom['panelbackend/risk_risiko_grc']['view_all_direktorat']){
...
<?php if(!$editedheader1 && $this->access_role['edit']  && (!$rowheader1['is_lock'] or $this->access_role_custom['panelbackend/risk_risiko_grc']['view_all_direktorat'])){ 
        ?>
    <a href="<?=site_url("panelbackend/risk_mitigasi_grc/index/$rowheader1[id_risiko]/0/1")?>" class="btn btn-xs btn-default fright"><span class="glyphicon glyphicon-edit"></span> Edit</a>
    <?php } ?>
</div>
