...
<?php 
$from = UI::createSelect('id_taksonomi_objective',$objectivearr,$row['id_taksonomi_objective'],$edited,'form-control ',"style='width:auto; max-width:100%;'");
echo UI::createFormGroup($from, $rules["id_taksonomi_objective"], "id_taksonomi_objective", "Taksonomi");
?>
