...
<html xmlns="http://www.w3.org/1999/xhtml">
    <head>
        ...
        <link href="<?=site_url()?>assets/js/filemanager/css/bootstrap.min.css" rel="stylesheet" type="text/css" />
        <link href="<?=site_url()?>assets/js/filemanager/css/bootstrap-lightbox.min.css" rel="stylesheet" type="text/css" />
        <link href="<?=site_url()?>assets/js/filemanager/css/style.css" rel="stylesheet" type="text/css" />
		<link href="<?=site_url()?>assets/js/filemanager/css/dropzone.css" type="text/css" rel="stylesheet" />
	<!--[if lt IE 8]><style>
	.img-container span {
        ...
        <script data-cfasync="false" type="text/javascript" src="<?=site_url()?>assets/js/filemanager/js/jquery.1.9.1.min.js"></script>
        <script data-cfasync="false" type="text/javascript" src="<?=site_url()?>assets/js/filemanager/js/bootstrap.min.js"></script>
        <script data-cfasync="false" type="text/javascript" src="<?=site_url()?>assets/js/filemanager/js/bootstrap-lightbox.min.js"></script>
		<script data-cfasync="false" type="text/javascript" src="<?=site_url()?>assets/js/filemanager/js/dropzone.min.js"></script>
		<script data-cfasync="false" type="text/javascript" src="<?=site_url()?>assets/js/filemanager/js/jquery.touchSwipe.min.js"></script>
		<script data-cfasync="false" src="<?=site_url()?>assets/js/filemanager/js/modernizr.custom.js"></script>
	...
	<script data-cfasync="false" type="text/javascript" src="<?=site_url()?>assets/js/filemanager/js/include.js"></script>
    </head>
    <body>
...
<!-- header div end -->
	...
	?>
	<li class="pull-right"><a id="refresh" href="<?=site_url("panelbackend/filemanager")?>?type=<?php echo $_GET['type']?>&multipleselect=<?=$_GET['multipleselect']?>&editor=<?php echo $_GET['editor'] ? $_GET['editor'] : 'mce_0'; ?>&subfolder=<?php echo $subfolder ?>&popup=<?php echo $popup;?>&field_id=<?php echo $_GET['field_id'] ? $_GET['field_id'] : '';?>&lang=<?php echo $_GET['lang'] ? $_GET['lang'] : 'en_EN'; ?>&fldr=<?php echo $subdir ?>&<?php echo uniqid() ?>"><i class="icon-refresh"></i></a></li>
	</ul>
    </div>
    <!-- breadcrumb div end -->
