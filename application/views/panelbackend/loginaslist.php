  <table class="table table-striped table-hover dataTable">
    ...
    foreach($list['rows'] as $rows){
    	...
    	echo '<td style="text-align:right"><input class="btn waves-effect btn-sm btn-primary" value="LOGIN" onclick="return goLogin(\''.$rows['user_id'].'\')" type="button"></td>';
    	echo "</tr>";
    }
    if(!$list['rows']){
