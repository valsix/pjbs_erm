<div  class="header">
    ...
    <?
    if($_SESSION[SESSION_APP][$rowheader['id_scorecard']]<>'lampiran')
    {
        ?>
...
if ($_SESSION[SESSION_APP][$rowheader['id_scorecard']]=='lampiran') 
{
    ...
    <!-- <div class="col-sm-12"> -->
        <?php 
        $form = require_once("_lampiranfoldergrc.php");
      ...
      <table class="table table-bordered table-hover dataTable">
        ...
        foreach($list['rows'] as $rows){
          ...
          echo "<td>$i</td>";
            ...
            $val = $rows[$rows1['name']];
                if($rows1['name']=='nama'){
                      echo "<td><a href='".($url=base_url("panelbackend/risk_risiko_grc/detail/{$rows['id_scorecard']}/$rows[$pk]"))."'>".nl2br($val)."</a>";
