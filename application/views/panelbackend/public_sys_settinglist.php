  <table class="table table-bordered table-hover dataTable">
    ...
    foreach($list['rows'] as $rows){
    	...
    	".UI::getButton('edit', $rows[$pk], 'class="btn waves-effect btn-xs btn-warning"', 'btn-xs', "Edit");
		/*".UI::getButton('delete', $rows[$pk], 'class="btn waves-effect btn-xs btn-danger"', 'btn-xs', null)."*/
    	echo "</td>";
    	echo "</tr>";
    }
    if(!$list['rows']){
