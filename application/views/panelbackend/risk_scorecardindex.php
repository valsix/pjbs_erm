    ...
    <div class="row clearfix">
        <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
            <div class="card">
                <div class="header">
                    <h2>
                    <center>LINGKUP KAJIAN RISIKO</center>
                    </h2>
                </div>
                ...
                <div class="body" style="padding:30px 20%;">
                   ...
                   <br/>
                    ...
                    if(in_array($k, $kajiankuarr)){ ?>
                       <a href="<?=site_url('panelbackend/risk_scorecard/index/'.$k)?>" class="btn btn-info waves-effect btn-lg btn-block">
                       <h4><?=str_replace("KAJIAN RISIKO","",strtoupper($v))?></h4>
                       </a>
                   <?php } else { ?>
                       <a href="<?=site_url('panelbackend/risk_scorecard/index/'.$k)?>" class="btn btn-default waves-effect btn-lg btn-block">
