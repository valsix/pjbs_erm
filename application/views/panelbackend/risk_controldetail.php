...
<div  class="header">
    ...
    <?php 
    	...
    	?>
    <?php 
    if($this->access_role_custom['panelbackend/risk_risiko']['view_all_direktorat'] && $row['is_lock']=='1' && $this->access_role['edit']){
    ?>
...
if($row['id_mitigasi_sumber']){
	$from = '<a href="'.site_url('panelbackend/risk_mitigasi/detail/'.$rowheader1['id_risiko'].'/'.$row['id_mitigasi_sumber']).'"><span class="label label-primary">DARI MITIGASI</span></a>';
