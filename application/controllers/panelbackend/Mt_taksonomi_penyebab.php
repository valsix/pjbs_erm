...
class Mt_taksonomi_penyebab extends _adminController{
	...
	protected function init(){
		parent::init();
		$this->viewlist = "panelbackend/mt_taksonomi_penyebablist";
		$this->viewdetail = "panelbackend/mt_taksonomi_penyebabdetail";
		$this->template = "panelbackend/main";
		$this->layout = "panelbackend/layout_taksonomi";

		if ($this->mode == 'add') {
			$this->data['page_title'] = 'Tambah Penyebab';
			$this->data['edited'] = true;
		}
		elseif ($this->mode == 'edit') {
			$this->data['page_title'] = 'Edit Penyebab';
			$this->data['edited'] = true;	
		}
		elseif ($this->mode == 'detail'){
			$this->data['page_title'] = 'Detail Penyebab';
			$this->data['edited'] = false;	
		}else{
			$this->data['page_title'] = 'Daftar Penyebab';
		}

		$this->data['width'] = "800px";

		$this->load->model("Mt_taksonomi_penyebabModel","model");

		$this->data['jenisarr'] = array(0=>'Tidak ada',1=>'Internal',2=>'Eksternal');
