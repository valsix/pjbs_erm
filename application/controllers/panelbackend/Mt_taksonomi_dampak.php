...
class Mt_taksonomi_dampak extends _adminController{
	...
	protected function init(){
		parent::init();
		$this->viewlist = "panelbackend/mt_taksonomi_dampaklist";
		$this->viewdetail = "panelbackend/mt_taksonomi_dampakdetail";
		$this->template = "panelbackend/main";
		$this->layout = "panelbackend/layout_taksonomi";

		if ($this->mode == 'add') {
			$this->data['page_title'] = 'Tambah Dampak';
			$this->data['edited'] = true;
		}
		elseif ($this->mode == 'edit') {
			$this->data['page_title'] = 'Edit Dampak';
			$this->data['edited'] = true;	
		}
		elseif ($this->mode == 'detail'){
			$this->data['page_title'] = 'Detail Dampak';
			$this->data['edited'] = false;	
		}else{
			$this->data['page_title'] = 'Daftar Dampak';
		}

		$this->data['width'] = "800px";

		$this->load->model("Mt_taksonomi_dampakModel","model");
