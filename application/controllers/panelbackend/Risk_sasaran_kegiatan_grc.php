...
class Risk_sasaran_kegiatan_grc extends _adminController{
	...
	protected function init(){
		parent::init();
		$this->viewlist = "panelbackend/risk_sasaran_kegiatan_grclist";
		$this->viewdetail = "panelbackend/risk_sasaran_kegiatandetail";
		$this->template = "panelbackend/main";
		$this->layout = "panelbackend/layout_scorecard_grc";

		if ($this->mode == 'add') {
			$this->data['page_title'] = 'Tambah Sasaran Kegiatan GRC';
			$this->data['edited'] = true;
		}
		elseif ($this->mode == 'edit') {
			$this->data['page_title'] = 'Edit Sasaran Kegiatan GRC';
			$this->data['edited'] = true;
		}
		elseif ($this->mode == 'detail'){
			$this->data['page_title'] = 'Detail Sasaran Kegiatan GRC';
			$this->data['edited'] = false;
		}elseif($this->mode == 'index'){
			$this->data['edited'] = true;
			$this->data['page_title'] = 'Daftar Sasaran Kegiatan GRC';
		}
		...
		$this->SetAccess('panelbackend/mekanisme_grc');
