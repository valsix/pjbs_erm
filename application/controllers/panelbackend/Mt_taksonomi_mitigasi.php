...
class Mt_taksonomi_mitigasi extends _adminController{
	...
	protected function init(){
		parent::init();
		$this->viewlist = "panelbackend/mt_taksonomi_mitigasilist";
		$this->viewdetail = "panelbackend/mt_taksonomi_mitigasidetail";
		...
		elseif ($this->mode == 'detail'){
			$this->data['page_title'] = 'Detail Mitigasi';
			$this->data['edited'] = false;	
		}else{
			$this->data['page_title'] = 'Daftar Mitigasi';
		}

		$this->data['width'] = "800px";

		$this->load->model("Mt_taksonomi_mitigasiModel","model");
